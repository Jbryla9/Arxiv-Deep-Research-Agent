...
fromstate_arxiv import DeepAgentState
...
@tool(description=READ_FILE_DESCRIPTION, parse_docstring=False)
def read_file(
    file_path: str,
...
@tool(description=WRITE_FILE_DESCRIPTION, parse_docstring=False)
def write_file(
    file_path: str,
    content: str,
    state: Annotated[DeepAgentState, InjectedState],
